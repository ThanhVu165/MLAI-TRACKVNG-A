...
### S-01 · Đóng băng contract `core/types.py` [DONE]
- **Khối:** B0 · **Ước lượng:** 2h · **Phụ thuộc:** — · **Người làm:** cả 3, A cầm bút · **Trạng thái:** `DONE`
- **File:** `core/types.py`
- **Việc phải làm:**
...
### A-01 · Khung package `core/` và bộ khung pipeline [DONE]
- **Khối:** B0 · **Ước lượng:** 1h · **Phụ thuộc:** S-01 · **Trạng thái:** `DONE`
...
### A-02 · R0 Intake [DONE]
- **Khối:** B1 · **Ước lượng:** 1h · **Phụ thuộc:** A-01, C-02 · **Trạng thái:** `DONE`
...
### A-03 · R1 Sanitize — bóc chữ ký, quote, HTML [DONE]
- **Khối:** B1 · **Ước lượng:** 2h · **Phụ thuộc:** A-01 · **Trạng thái:** `DONE`
...
### A-04 · R1 Nhận diện ngôn ngữ [DONE]
- **Khối:** B1 · **Ước lượng:** 45ph · **Phụ thuộc:** A-03 · **Trạng thái:** `DONE`
- **File:** `core/sanitize.py`
...
### A-05 · R1 Nhận diện và che PII [DONE]
- **Khối:** B1 · **Ước lượng:** 1.5h · **Phụ thuộc:** A-03 · **Trạng thái:** `DONE`
- **File:** `core/sanitize.py`
...
### A-06 · R1 Nhận diện prompt injection [DONE]
- **Khối:** B1 · **Ước lượng:** 1.5h · **Phụ thuộc:** A-03 · **Trạng thái:** `DONE`
- **File:** `core/sanitize.py`
...
### A-07 · R1 Ba chốt chặn rẻ [DONE]
- **Khối:** B1 · **Ước lượng:** 1h · **Phụ thuộc:** A-03, A-04 · **Trạng thái:** `DONE`
- **File:** `core/sanitize.py`
...
### A-08 · R2 Prompt và schema trích xuất [DONE]
- **Khối:** B1 · **Ước lượng:** 2.5h · **Phụ thuộc:** A-01, C-04 · **Trạng thái:** `DONE`
...
### A-09 · R2 Retry, timeout và fail-safe [DONE]
- **Khối:** B1 · **Ước lượng:** 1h · **Phụ thuộc:** A-08 · **Trạng thái:** `DONE`
- **File:** `core/extract.py`
...
### A-11 · R4 Adapter retrieval [DONE]
- **Khối:** B2 · **Ước lượng:** 1.5h · **Phụ thuộc:** A-10, B-01 · **Trạng thái:** `DONE`
...
### A-12 · R5 Evidence Validator [DONE]
- **Khối:** B2 · **Ước lượng:** 2.5h · **Phụ thuộc:** A-11 · **Trạng thái:** `DONE`
...
### A-13 · R6 Policy Engine [DONE]
- **Khối:** B2 · **Ước lượng:** 3h · **Phụ thuộc:** A-12, A-14 · **Trạng thái:** `DONE`
...
### A-14 · Ba file YAML cấu hình chính sách [DONE]
- **Khối:** B1 · **Ước lượng:** 1.5h · **Phụ thuộc:** S-01 · **Trạng thái:** `DONE`
...
### A-15 · R7a Sinh câu trả lời tự động [DONE]
- **Khối:** B3 · **Ước lượng:** 2.5h · **Phụ thuộc:** A-13 · **Trạng thái:** `DONE`
...
### A-16 · R8a Groundedness Guard [DONE]
- **Khối:** B3 · **Ước lượng:** 3h · **Phụ thuộc:** A-15 · **Trạng thái:** `DONE`
...
### A-17 · R7b Sinh câu hỏi chuyển tiếp [DONE]
- **Khối:** B3 · **Ước lượng:** 2.5h · **Phụ thuộc:** A-13 · **Trạng thái:** `DONE`
...
### A-18 · R8b Question Quality Guard [DONE]
- **Khối:** B3 · **Ước lượng:** 2h · **Phụ thuộc:** A-17, A-14 · **Trạng thái:** `DONE`
...
### A-19 · R9a/R13 Vòng đời gửi và Correction Email [DONE]
- **Khối:** B3 · **Ước lượng:** 2h · **Phụ thuộc:** A-16 · **Trạng thái:** `DONE`
...
### A-20 · R11 Resume sau quyết định của người [DONE]
- **Khối:** B3 · **Ước lượng:** 2h · **Phụ thuộc:** A-18, C-13 · **Trạng thái:** `DONE`
- **File:** `core/resume.py`
...
### A-21 · Ráp `process_case()` và máy trạng thái [DONE]
- **Khối:** B2 · **Ước lượng:** 3h · **Phụ thuộc:** A-02..A-13 · **Trạng thái:** `DONE`
- **File:** `core/pipeline.py`
...
### A-22 · `controls.py` — Pause, Resume, Override, Re-run [DONE]
- **Khối:** B4 · **Ước lượng:** 2.5h · **Phụ thuộc:** A-21 · **Trạng thái:** `DONE`
...
### A-23 · `explain.py` — Giải thích cho người không chuyên [DONE]
- **Khối:** B4 · **Ước lượng:** 1.5h · **Phụ thuộc:** A-21 · **Trạng thái:** `DONE`
...
### A-24 · Xử lý email đa ý định [DONE]
- **Khối:** B3 · **Ước lượng:** 2h · **Phụ thuộc:** A-10, A-15, A-17 · **Trạng thái:** `DONE`
...
### A-36 · Câu hỏi chuyển tiếp bám đúng ý cần quyết định [DONE]
- **Khối:** Ổn định sau audit · **Ước lượng:** 1h · **Phụ thuộc:** A-17, A-30 · **Trạng thái:** `DONE`
